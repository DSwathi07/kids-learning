...
echo         <h1 class="text-3xl font-bold text-center text-gray-800 mb-6">Profile</h1> 
echo         <p class="text-center text-gray-600 mb-6">Manage your account details here.</p> 
