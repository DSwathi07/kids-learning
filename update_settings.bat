...
echo     <title>Settings - EduApp</title> 
...
echo         <h1 class="text-3xl font-bold text-center text-gray-800 mb-6">Settings</h1> 
echo         <p class="text-center text-gray-600 mb-6">Customize your app preferences here.</p> 
